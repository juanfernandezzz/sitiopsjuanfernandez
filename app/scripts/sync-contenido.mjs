...
const archivos = ['contacto.js', 'cal.js', 'faqData.js', 'precios.js', 'motivos.js', 'credenciales.js', 'sobreMi.js', 'respiraNucleo.js', 'hero.js', 'sesiones.js', 'proceso.js', 'postReserva.js'];
