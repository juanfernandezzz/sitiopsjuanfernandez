...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Es una herramienta gratuita de este sitio, en psicologojuanfernandez.cl/respira: una figura que se expande y se recoge para guiar tu respiración. Puedes elegir entre dos ritmos con un botón. El primero es la respiración coherente: inhalas y exhalas 5,5 segundos cada vez, cerca de 6 respiraciones por minuto. Sincroniza la respiración con el ritmo cardíaco y puede ayudar con la autorregulación emocional, el estrés, la ansiedad o la concentración. El segundo es la respiración 4-7-8: inhalas 4 segundos, sostienes el aire 7 y exhalas 8, con la salida del aire más larga que la entrada, algo que favorece la respuesta de calma del cuerpo; es un patrón muy difundido, con evidencia específica más limitada que la del primero. La inicias y la pausas cuando quieras: con la respiración coherente, entre 3 y 5 minutos funcionan bien para la mayoría; con la 4-7-8 conviene empezar con 4 ciclos e ir viendo cómo te sienta. Es un apoyo para la relajación: no es un tratamiento ni reemplaza un proceso de psicoterapia. Si sientes mareo o incomodidad, detente y vuelve a tu ritmo natural.',
