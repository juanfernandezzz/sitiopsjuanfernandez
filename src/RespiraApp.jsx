    ...
    <div className="bg-cream min-h-screen flex flex-col text-ink">
      ...
      <main className="flex-1 w-full">
        <div className="mx-auto max-w-3xl px-5 md:px-8 pt-6 md:pt-10 pb-16 md:pb-20">
          ...
          >
            Un ejercicio visual para bajar el ritmo: la figura se expande cuando inhalas y se recoge cuando exhalas, a un ritmo lento, cercano a 6 respiraciones por minuto. Respira de forma suave y silenciosa, sin forzar. Cada inhalación y cada exhalación dibujan una figura nueva.
          </p>
